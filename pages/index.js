  ...
  render() {
    return(
      <Layout>
        ...
        <p>I&apos;m a junior at Dougherty Valley High School, intent on going into CS or EECS in the future. I love programming, linux, hardware, just about everything tech-related 🙂. I primarily do back-end work, with a little bit of web-dev and mobile development on the side.</p>
        ...
        <ul>
          ...
          <li>I started competing in competitive robotics in late 2018. In an odd little paradox, building inanimate machines taught me how to better interact with those around me, honing both my communication and leadership skills.</li>
